...
public class SingleAdapter<T> extends RecyclerView.Adapter<SingleAdapter.ViewHolder> {
    ...
    private List<T> mDatasetTemp = new ArrayList<>();
    ...
    private void diffCheck(@NonNull List<T> data) {
        DiffUtil.DiffResult diffResult = DiffUtil.calculateDiff(new DiffUtil.Callback() {
            ...
            public boolean areItemsTheSame(int oldItemPosition, int newItemPosition) {
                return false; //mDataset.get(oldItemPosition).toString().equals(data.get(newItemPosition).toString());
            }

            @Override
            public boolean areContentsTheSame(int oldItemPosition, int newItemPosition) {
                return Objects.equals(mDataset.get(oldItemPosition), data.get(newItemPosition));
            }
        });
